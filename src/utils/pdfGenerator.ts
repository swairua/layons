    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand-header { border:none; border-radius:0; padding:0; width:calc(100% + 24mm); margin:0 -12mm 0 -12mm; box-sizing:border-box; }
        .brand-row { display:flex; align-items:center; justify-content:flex-start; margin:0; padding:0; width:100%; }
        .brand-logo { height:90px; display:flex; align-items:center; justify-content:flex-start; flex:1; margin:0; padding:0; width:100%; }
        .brand-logo img { height:90px; width:100%; object-fit:cover; margin:0; padding:0; display:block; }
        .brand-accent { margin:0 -12mm 0 -12mm; display:flex; align-items:center; gap:0; height:14px; width:calc(100% + 24mm); }
