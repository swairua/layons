      ...
      <div class="terms-page" style="padding: 12mm;">
        ...
        <div style="margin-bottom: 25px;">
          ...
          <ol style="font-size: 11px; line-height: 1.6; margin: 0; padding-left: 20px; color: #333;">
            ...
            <li style="margin-bottom: 6px; margin-left: 20px;">a. 50% Upon Order (${formatCurrency(grandTotalForBOQ * 0.5)})</li>
            <li style="margin-bottom: 6px; margin-left: 20px;">b. 40% As Progressive (${formatCurrency(grandTotalForBOQ * 0.4)})</li>
            <li style="margin-bottom: 6px; margin-left: 20px;">c. 10% Upon Completion (${formatCurrency(grandTotalForBOQ * 0.1)})</li>
      ...
      <div class="page" style="position: relative; page-break-before: always;">
        <div style="padding: 0;">
          ...
          <div style="margin-bottom: 25px;">
            ...
            <ol style="font-size: 11px; line-height: 1.6; margin: 0; padding-left: 20px; color: #333;">
              <li style="margin-bottom: 6px;">The Payment terms for each stage are as follows;</li>
              <li style="margin-bottom: 6px; margin-left: 20px;">a. 50% Upon Order (${formatCurrency(grandTotal * 0.5)})</li>
              <li style="margin-bottom: 6px; margin-left: 20px;">b. 40% As Progressive (${formatCurrency(grandTotal * 0.4)})</li>
              <li style="margin-bottom: 6px; margin-left: 20px;">c. 10% Upon Completion (${formatCurrency(grandTotal * 0.1)})</li>
              <li style="margin-bottom: 6px;">All work will be executed based on the drawings and samples approved by the client</li>
              <li style="margin-bottom: 6px;">Any Changes/alterations to the scope of work outlined will affect the final quantity will be measured, and charges will be applied on a pro-rata basis at the agreed rate</li>
              <li style="margin-bottom: 6px;">We are not responsible for any damages caused by negligence from other Sub Contractors Hired by the Client.</li>
              <li style="margin-bottom: 6px;">The quotation does not include statutory fees.</li>
